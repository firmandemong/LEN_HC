                    ...
                    <tbody>
                        @foreach ($majors as $major)
                            <tr>
                                ...
                                <td>{{ $major->name }}</td>
                                <td>
                                    <button button id="edit-button" data-id="{{ $major->id }}"
                                        data-name="{{ $major->name }}" data-toggle="modal" data-target="#edit-modal"
                                        class="btn btn-warning btn-sm">Edit</button>
                                    <button button id="delete-button" data-id="{{ $major->id }}" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-dismiss="modal"
                        id="add-major-form-button">Tambah</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" data-dismiss="modal"
                        id="edit-major-form-button">Edit</button>
                </div>
            </div>
        </div>
    </div>
