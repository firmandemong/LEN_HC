    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="table-responsive p-3">
                <button class="btn btn-primary mb-3" id="add-button" data-toggle="modal" data-target="#add-modal">Tambah
                    Data</button>
                        ...
                        @foreach ($divisions as $division)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button button id="delete-button" data-id="{{ $division->id }}" data-toggle="modal"
                                        data-target="#delete-modal" class="btn btn-danger btn-sm">Delete</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                ...
                <div class="modal-body">
                    <form id="add-division-form" action="{{ route('division.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" maxlength="3" class="form-control" id="quota" name="quota"
                                required>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-division-form" onkeydown="return event.key != 'Enter';" method="post">
                        ...
                        <div class="mb-3">
                            <label for="division_name" class="form-label">Kuota</label>
                            <input type="number" min="0" maxlength="3" class="form-control" id="edit_quota"
                                name="quota" required>
                        </div>
                    </form>
                </div>
