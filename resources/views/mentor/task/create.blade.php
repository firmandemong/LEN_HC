                    ...
                    <form action="/list-tugas/store" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('task_name') is-invalid @enderror"
                                id="task_name" name="task_name" placeholder="Nama Tugas" required>
                            @error('task_name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('task_description') is-invalid @enderror" id="task_description"
                                name="task_description" placeholder="Deskripsi Tugas" required></textarea>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <select name="participant" id=""
                                        class="form-select @error('participant') is-invalid @enderror" required>
                        ...
                        <button type="submit" class="btn btn-primary"
                            style="float: right; margin-bottom:20px">Tambah</button>
                    </form>
                </div>
            </div>
        </div>
