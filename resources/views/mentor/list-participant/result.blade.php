...
@section('subheader')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Hasil Evaluasi {{$participant->name}}</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page"><a href="/nilai-peserta">Nilai & Sertifikat</a></li>
            <li class="breadcrumb-item" aria-current="page">Hasil Evaluasi</li>
        </ol>
    </div>
@endsection
